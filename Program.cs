    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                using (StreamReader sr = new StreamReader(@"E:\Progetti\MyProgetti\Downloader\Downloader\bin\Link\Link.txt"))
                {
                    String line;
                    ...
                    while ((line = sr.ReadLine()) != null)
                    {
                        ...
                        //linkToDownload.Add(new Link(line, line.Substring(line.LastIndexOf("/")+1)));
                        linkToDownload.Add(new Link(line, i + ".wmv"));
                    }
                }
            }
            catch (Exception e)
